    ...
    return (
        <div className="intro-container">
            ...
            <div className="intro-content">
                ...
                <h1 className="intro-h1">Best Mobile Application Testing Training Institute in Chennai</h1>
                <h3 className="intro-h3">Master the art of mobile app testing with our expert-led training – your pathway to a thriving career in quality assurance and software testing.</h3>
