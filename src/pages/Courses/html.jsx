...
const Intro = ({ openContactModal }) => {
    ...
    <div style={{ width: "100%", height: "100vh", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", color: "white", overflow: "hidden" }}>
      ...
      <div className="intro-content">
          ...
          <h3 className="intro-h3">Master web development with our expert-led HTML Training – your gateway to a thriving career in front-end development.</h3>
            ...
            <div className="sap-training-content">
                <div className="training-details">
                    ...
                    <ul className="benefits-list">
                        <li><span className="icon">✓</span> Build a strong foundation in HTML for creating responsive and modern websites.</li>
                        <li><span className="icon">✓</span> Learn from practicing HTML developers with real-time project experience.</li>
                        <li><span className="icon">✓</span> Benefit from IntelliMindz's proven expertise in delivering successful HTML training.</li>
...
const CorporateTrainingModesSection = () => {
    const trainingModesData = [
        { id: 1, imageSrc: corporateOnsiteImg, altText: "Onsite corporate HTML training", title: "Onsite Training:", description: "Conducted at your company’s premises, this training offers a tailored learning experience using your web development environment for maximum relevance." },
...
const AlumniReviewsSection = () => {
    const reviewsData = [
        { id: 1, name: "Arun M.", designation: "Web Developer", avatarInitial: "A", rating: 5, companyLogoText: "Intellimindz", reviewText: "IntelliMindz’s HTML course was exceptional. The hands-on labs on semantic markup and responsive design helped me master web development skills. The trainers were highly supportive." },
        ...
        { id: 3, name: "Vignesh T.", designation: "Web Development Consultant", avatarInitial: "V", rating: 5, companyLogoText: "Intellimindz", reviewText: "IntelliMindz’s practical content and flexible timings were perfect. The real-world scenarios prepared me well for my web development role." },
        ...
        { id: 5, name: "Ramesh A.", designation: "Senior Web Developer", avatarInitial: "R", rating: 5, companyLogoText: "Intellimindz", reviewText: "The course’s depth and practical approach made advanced HTML topics like HTML5 APIs and responsive design easy to grasp. Highly recommend for professionals." }
    ];
...
const SapABAPFaqSection = () => {
    ...
    const modulesData = [
        ...
        { id: 5, title: "What’s the difference between HTML and CSS?", description: "HTML provides the structure and content of a webpage, while CSS is used for styling and designing the visual presentation." },
