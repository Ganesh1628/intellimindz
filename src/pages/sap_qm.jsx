...
import aboutsapficoImg from '../assests/images/aboutsapfico.jpeg'; // Kept for About Section, might need QM specific image
...
const Saponline = ({ openContactModal }) => {
  return (
    <>
      ...
      <SAPAboutSection /> 
      <KeyFeaturesSection /> 
      <SapFicoCourseContentSection openContactModal={openContactModal} /> {/* Name kept, content is QM */}
      <BatchDetailsSection openContactModal={openContactModal} />
      <CorporateTrainingModesSection /> 
      <AlumniReviewsSection /> 
      {AskForDemo && <AskForDemo />} 
      <Onlineheader /> 
      <SapImSyllabus /> {/* Name kept, content is QM FAQ */}
