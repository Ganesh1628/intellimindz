...
const pageTitle = "Best SAP QM Training in Chennai | Expert-Led SAP QM Course";
const pageDescription = "Enroll in top-rated SAP QM training in Chennai at Intellimindz. Master SAP QM concepts with real-time projects and expert guidance.";
const pageKeywords = "sap qm training in chennai, sap qm course, sap qm certification, intellimindz";
const ogUrl = "https://localhost:3000/sap_qm_training_in_chennai";
    return (
    <>
      <Meta
        title={pageTitle}
