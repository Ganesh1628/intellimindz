...
const Intro = ({ openContactModal }) => {
    ...
    <div style={{ width: "100%", height: "100vh", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", color: "white", overflow: "hidden" }}>
      ...
      <div className="intro-content">
          ...
          <h3 className="intro-h3">Master data integration and business analytics with our expert-led Pentaho Training – your pathway to a thriving career in data management.</h3>
            ...
            <div className="sap-training-content">
                <div className="training-details">
                    ...
                    <ul className="benefits-list">
                        <li><span className="icon">✓</span> Build a strong foundation in Pentaho for data integration and analytics.</li>
                        <li><span className="icon">✓</span> Learn from practicing Pentaho professionals with real-time project experience.</li>
                        <li><span className="icon">✓</span> Benefit from IntelliMindz's proven expertise in delivering successful Pentaho training.</li>
                        <li><span className="icon">✓</span> Receive comprehensive career support, including resume guidance and interview preparation.</li>
                        <li><span className="icon">✓</span> Work on real-world data integration scenarios to gain job-ready skills.</li>
...
const CorporateTrainingModesSection = () => {
    const trainingModesData = [
        { id: 1, imageSrc: corporateOnsiteImg, altText: "Onsite corporate Pentaho training", title: "Onsite Training:", description: "Conducted at your company’s premises, this training offers a tailored learning experience using your data environment for maximum relevance." },
...
const AlumniReviewsSection = () => {
    const reviewsData = [
        { id: 1, name: "Arun M.", designation: "Data Integration Specialist", avatarInitial: "A", rating: 5, companyLogoText: "Intellimindz", reviewText: "IntelliMindz’s Pentaho course was exceptional. The hands-on labs on ETL development and reporting helped me master data integration skills. The trainers were highly supportive." },
        ...
        { id: 3, name: "Vignesh T.", designation: "Pentaho Consultant", avatarInitial: "V", rating: 5, companyLogoText: "Intellimindz", reviewText: "IntelliMindz’s practical content and flexible timings were perfect. The certification prep and real-world scenarios prepared me well for my Pentaho role." },
        ...
        { id: 5, name: "Ramesh A.", designation: "Senior BI Developer", avatarInitial: "R", rating: 5, companyLogoText: "Intellimindz", reviewText: "The course’s depth and practical approach made advanced Pentaho topics like cloud integration and data warehousing easy to grasp. Highly recommend for professionals." }
    ];
...
const SapABAPFaqSection = () => {
    ...
    const modulesData = [
        ...
        { id: 5, title: "What’s the difference between Pentaho and Talend?", description: "Pentaho offers robust BI and reporting features alongside ETL, while Talend focuses primarily on data integration and ETL processes." },
