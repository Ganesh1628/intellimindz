...
const SapFicoCourseContentSection = ({ openContactModal }) => {
  ...
  const allModulesData = [
    { id: 1, title: "Module 1: Introduction to SAP ABAP", topics: ["Introduction to ERP and SAP", "Basics of SAP NetWeaver Architecture", "Overview of SAP Modules and ABAP’s Role", "SAP Logon, Navigation, and System Landscape", "ABAP Workbench Introduction", "Structure of an ABAP Program", "Data Dictionary Basics"] },
