...
const pageTitle = "Best SAP SCM Training in Chennai | Expert-Led SAP SCM Course";
const pageDescription = "Join SAP SCM training in Chennai at Intellimindz to learn supply chain processes, planning, and execution modules.";
const pageKeywords = "sap scm training in chennai, sap scm course, sap scm certification, intellimindz";
const ogUrl = "https://localhost:3000/sap_scm_training_in_chennai";
    return (
    <>
      <Meta
        title={pageTitle}
